<properties 
    pageTitle="Guia de programação dos Event Hubs do Azure | Microsoft Azure"
...
## Criar um cliente dos Event Hubs
...
## Enviar no modo assíncrono e enviar à escala
...
### Anfitrião do processador de eventos
...
- [Descrição geral da API dos Event Hubs](event-hubs-api-overview.md)
- [Descrição geral dos Event Hubs](event-hubs-overview.md)
- [Exemplos de código dos Event Hubs](http://code.msdn.microsoft.com/site/search?query=event hub&f[0].Value=event hub&f[0].Type=SearchText&ac=5)
- [Referência da API do anfitrião do processador de eventos](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventprocessorhost.aspx)
