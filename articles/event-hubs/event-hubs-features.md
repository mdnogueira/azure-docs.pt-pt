...
Este artigo baseia-se as informações de [descrição geral](event-hubs-what-is-event-hubs.md)e fornece detalhes técnicos e implementação sobre as funcionalidades e componentes de Event Hubs.
