...
* **Node.js**: [Como utilizar Notification Hubs do Node.js](notification-hubs-nodejs-how-to-use-notification-hubs.md).
...
* **Java / PHP**: Para um exemplo sobre como enviar notificações de emissão utilizando as APIs REST, consulte "Como utilizar Notification Hubs de Java/PHP" ([Java](notification-hubs-java-backend-how-to.md) | [PHP](notification-hubs-php-backend-how-to.md)).
