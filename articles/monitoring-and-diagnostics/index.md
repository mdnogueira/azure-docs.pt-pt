---
title: "Documentação do Azure Monitor - Tutoriais, Referência da API | Microsoft Docs"
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre a Monitorização do Azure e os diagnósticos</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Centro de vídeo do Azure Monitor</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar alertas para serviços do Azure com o Portal do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar alertas para serviços do Azure com a CLI multiplataformas</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar alertas para serviços do Azure com o PowerShell</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Monitorização</h3>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-supported-metrics">Lista de Métricas Suportadas</a></p>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-data-sources">Origens dos dados de monitorização</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Diagnóstico</h3>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-versioning-history">Histórico de versões da extensão do Diagnóstico do Azure</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema">Esquema da extensão do Diagnóstico do Azure</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot0">Esquema da extensão do Diagnóstico do Azure 1.0</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot2">Esquema da extensão do Diagnóstico do Azure 1.2</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot3-and-later">Esquema da extensão do Diagnóstico do Azure 1.3 e posterior</a></p>
                    </div>
                </div>
            </div>
        </div>
