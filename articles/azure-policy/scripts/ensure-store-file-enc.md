---
title: "Json de política do Azure de exemplo - Certifique-se a encriptação de ficheiros de armazenamento | Microsoft Docs"
description: "Esta política de exemplo de json requer que a encriptação de ficheiros está ativada para contas de armazenamento."
...
---
# <a name="ensure-storage-file-encryption"></a>Certifique-se a encriptação de ficheiros de armazenamento

Esta política requer que a encriptação de ficheiros está ativada para contas de armazenamento.
