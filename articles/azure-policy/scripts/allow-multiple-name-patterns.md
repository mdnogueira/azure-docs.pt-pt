---
title: "Exemplo de json de política do Azure - vários padrões de nome | Microsoft Docs"
description: "Esta política de exemplo de json requer que corresponda recursos um dos padrões de nome fornecido."
...
---
# <a name="allow-multiple-name-patterns"></a>Permitir que vários padrões de nome

Permitir que um dos muitos padrões de nome a utilizar para recursos. Especifique os padrões de nome permitido na regra de política.
