---
title: "Json de política do Azure de exemplo - exigir encriptação de conta de armazenamento | Microsoft Docs"
description: "Esta política de exemplo de json requer que a conta de armazenamento para utilizar a encriptação de blob."
...
---
# <a name="require-storage-account-encryption"></a>Exigir encriptação de conta de armazenamento

Esta política requer que a conta de armazenamento para utilizar a encriptação de blob.
