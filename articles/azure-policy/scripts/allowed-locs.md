---
title: "Exemplo de json de política do Azure - permitido localizações | Microsoft Docs"
description: "Esta política de exemplo de json requer que todos os recursos são implementados em localizações aprovadas."
...
Esta política requer que todos os recursos são implementados em localizações aprovadas. Especifique uma matriz de localizações aprovadas.
