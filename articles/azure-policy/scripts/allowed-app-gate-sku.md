---
title: "Exemplo de json de política do Azure - permitido SKUs de gateway de aplicação | Microsoft Docs"
description: "Esta política de exemplo de json requer que os gateways de aplicação utilizam um SKU aprovado."
...
---
# <a name="allowed-application-gateway-skus"></a>SKUs de gateway de aplicações permitidas

Esta política requer que os gateways de aplicação utilizam um SKU aprovado. Especifique uma matriz de SKUs aprovados.
