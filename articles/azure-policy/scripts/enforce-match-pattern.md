---
title: "Json de política do Azure de exemplo - padrão de correspondência de impor | Microsoft Docs"
description: "Esta política de exemplo de json requer que os recursos satisfazem o padrão de correspondência para as convenções de nomenclatura."
...
---
# <a name="enforce-match-pattern-for-naming-conventions"></a>Impor o padrão de correspondência para as convenções de nomenclatura

Exigir um padrão como para as convenções de nomenclatura de cumprir os nomes de recursos. Especifique o padrão de correspondência permitido como um parâmetro.
