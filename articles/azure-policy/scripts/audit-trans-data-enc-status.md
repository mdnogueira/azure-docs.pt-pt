---
title: "Exemplo de json de política do Azure - estado de encriptação transparente de dados de auditoria | Microsoft Docs"
description: "Esta política de exemplo de json auditorias a encriptação transparente de dados do SQL Server da base de dados se não estiver ativada."
...
---
# <a name="audit-transparent-data-encryption-status"></a>Estado de encriptação transparente de dados de auditoria

Esta política auditorias a encriptação transparente de dados do SQL Server da base de dados se não estiver ativada.
