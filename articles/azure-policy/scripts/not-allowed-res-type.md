---
title: "Exemplo de json de política do Azure - tipos de recurso não é permitido | Microsoft Docs"
description: "Esta política de exemplo de json proíbe a implementação dos tipos de recurso especificado."
...
---
# <a name="not-allowed-resource-types"></a>Não é permitida tipos de recursos

Esta política proíbe a implementação dos tipos de recurso especificado. Especifique uma matriz de tipos de recursos para bloquear.
