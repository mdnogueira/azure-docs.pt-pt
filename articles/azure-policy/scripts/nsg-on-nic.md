---
title: "Exemplo de json de política do Azure - NSG x em cada NIC | Microsoft Docs"
description: "Esta política de exemplo de json requer que um grupo de segurança de rede específica é utilizado com cada interface de rede virtual."
...
Esta política requer que um grupo de segurança de rede específica é utilizado com cada interface de rede virtual. Especifique o ID do grupo de segurança de rede a utilizar.
