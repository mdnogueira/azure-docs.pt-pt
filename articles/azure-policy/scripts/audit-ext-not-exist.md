---
title: "Exemplo de json de política do Azure - auditoria se a extensão não existe | Microsoft Docs"
description: "Esta política de exemplo de json auditorias se uma extensão não estiver implementada com uma máquina virtual."
...
---
# <a name="audit-if-extension-does-not-exist"></a>Auditoria se a extensão não existe

Esta política auditorias se uma extensão não estiver implementada com uma máquina virtual. Especifique o fabricante de extensão e o tipo para verificar se esta foi implementada.
