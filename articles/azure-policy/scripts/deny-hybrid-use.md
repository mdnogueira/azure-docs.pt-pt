---
title: "Json de política do Azure de exemplo - negar a vantagem de utilizar híbrida | Microsoft Docs"
description: "Esta política de exemplo de json proíbe a utilização do Azure híbrida utilizar benefício (AHUB)."
...
---
# <a name="deny-hybrid-use-benefit"></a>Negar a vantagem de utilizar híbrida

Proíbe a utilização do Azure híbrida utilizar benefício (AHUB). Utilize quando não pretender permitir a utilização das licenças no local.
