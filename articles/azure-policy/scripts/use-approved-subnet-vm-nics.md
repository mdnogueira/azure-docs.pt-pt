---
title: "Exemplo de json de política do Azure - utilização aprovados sub-rede para interfaces de rede VM | Microsoft Docs"
description: "Esta política de exemplo de json requer que as interfaces de rede utilizam uma sub-rede aprovada."
...
---
# <a name="use-approved-subnet-for-vm-network-interfaces"></a>Utilizar a sub-rede aprovado para interfaces de rede VM

Esta política requer que as interfaces de rede utilizam uma sub-rede aprovada. Especifique o ID da sub-rede aprovado.
