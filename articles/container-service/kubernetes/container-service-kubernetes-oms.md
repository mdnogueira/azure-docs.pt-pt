...
Em alternativa, pode utilizar [Shell de nuvem do Azure](https://docs.microsoft.com/en-us/azure/cloud-shell/overview), que tem o `az` cli do Azure e `kubectl` ferramentas já instaladas por si.  
