...
Aqui pode ver que a versão atual do nó é `1.7.7` e essa versão `1.8.1` está disponível.
...
Utilize o `az aks upgrade` comando para atualizar os nós do cluster. Os exemplos seguintes atualiza o cluster para a versão `1.8.1`.
