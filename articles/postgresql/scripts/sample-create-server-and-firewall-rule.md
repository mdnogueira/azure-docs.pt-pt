...
| [firewall do servidor AZ postgres criar](/cli/azure/postgres/server/firewall-rule#create) | Cria uma regra de firewall para permitir o acesso ao servidor e bases de dados-lo do intervalo de endereços IP introduzido. |
