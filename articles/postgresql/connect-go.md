...
Instale o [Go](https://golang.org/doc/install) e o [controlador Pure Go Postgres (pq)](https://github.com/lib/pq) no seu computador. Dependendo da sua plataforma, siga os passos:
