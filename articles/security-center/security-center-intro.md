...
> [!NOTE]
> As informações neste documento aplicam-se ao pré-lançamento do Centro de Segurança do Azure. Este documento apresenta o serviço ao utilizar um exemplo de implementação.
> 
> 
...
> [!NOTE]
> Para modificar uma política de segurança ao nível da subscrição ou ao nível do grupo de recursos, tem de ser o Proprietário da subscrição ou um Contribuinte da mesma.
> 
> 
...
> [!NOTE]
> A recolha de dados e a escolha de uma conta do Storage por região é configurada ao nível da subscrição.
> 
> 
