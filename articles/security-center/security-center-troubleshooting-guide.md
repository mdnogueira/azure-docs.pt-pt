...
## Cenários de instalação do Agente de Monitorização da Microsoft
...
## Requisitos de resolução de problemas de rede do agente de monitorização
...
## A resolução de problemas do endpoint protection não está a funcionar corretamente
...
## Resolução de problemas ao carregar o dashboard
