...
8. No painel **Escolher contas de armazenamento**, clique em **OK**.
    ...
    > [AZURE.NOTE] Se preferir, pode agregar dados numa conta de armazenamento central para máquinas virtuais que estão em várias regiões. Consulte [FAQ do Centro de Segurança do Azure](security-center-faq.md) para obter mais informações.
...
> [AZURE.NOTE] Em caso de conflito entre a política de nível da subscrição e a política de nível do grupo de recursos, a política de nível de grupo de recursos tem prioridade.
