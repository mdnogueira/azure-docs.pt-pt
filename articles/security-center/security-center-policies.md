...
| Endpoint Protection | Recomenda que a Endpoint Protection seja aprovisionada para todas as máquinas virtuais do Windows de modo a ajudar a identificar e remover vírus, spyware e outro software malicioso. configurações específicas a serem monitorizadas. |
