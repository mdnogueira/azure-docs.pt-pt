<properties
   pageTitle="Monitorização de estado de funcionamento de segurança no Centro de Segurança do Azure | Microsoft Azure"
...
![Estado de funcionamento de recursos](./media/security-center-monitoring/security-center-monitoring-fig1-new3.png)
...
![Atualização do sistema em falta em VM](./media/security-center-monitoring/security-center-monitoring-fig2-2-new.png)
...
####Passos de integração
Esta secção mostra o número total de VMs que foram inicializadas para recolha de dados e o respetivo estado atual. Depois de todas as VMs terem inicializado a recolha de dados, estarão preparadas para receber políticas de segurança do Centro de Segurança. Quando clica nesta entrada, o painel **Inicializar recolha de dados** abre-se e será capaz de ver os nomes das VMs e o estado atual de recolha de dados na coluna **ESTADO DA INSTALAÇÃO**, conforme é mostrado abaixo.

![Estado de inicialização](./media/security-center-monitoring/security-center-monitoring-fig3-new.png)
...
![Recomendações da VM](./media/security-center-monitoring/security-center-monitoring-fig4-2-new.png)
...
![Atualizações do sistema em falta](./media/security-center-monitoring/security-center-monitoring-fig5-new.png)
...
No exemplo acima, uma VM tem uma recomendação crítica relativa a programas antimalware. Para obter mais informações sobre a VM, clique na mesma. Abre-se um novo painel que representa esta VM, conforme mostrado abaixo.

![Detalhes de Segurança de VM](./media/security-center-monitoring/security-center-monitoring-fig8-new.png)
...
![Restringir ponto final](./media/security-center-monitoring/security-center-monitoring-fig11-new2.png)
...
![Ponto final com acesso à Internet](./media/security-center-monitoring/security-center-monitoring-fig121-new5.png)
...
![Estado de funcionamento de Recursos SQL](./media/security-center-monitoring/security-center-monitoring-fig15-new.png)
...
![Estado de funcionamento de Recursos SQL](./media/security-center-monitoring/security-center-monitoring-fig16-new.png)
...
![Estado de funcionamento de Recursos SQL](./media/security-center-monitoring/security-center-monitoring-fig17-new.png)

Para ativar a auditoria, basta selecionar **ATIVAR** sob a opção **Auditoria** e, em seguida, clique em **Guardar**.
...
![Estado de funcionamento da segurança de aplicações](./media/security-center-monitoring/security-center-monitoring-fig18-new.png)
...
![Aplicações](./media/security-center-monitoring/security-center-monitoring-fig19-new.png)

O painel **Web Apps Não Seguras** terá uma lista de todas as VMs que contêm aplicações que são consideradas não seguras. A lista mostra o nome da VM, o estado atual do problema e a gravidade do problema. Se clicar nesta aplicação Web, o painel **Adicionar uma Firewall de Aplicação Web** será aberto com opções para que instale uma WAF (firewall de aplicação Web) de terceiros, conforme mostrado abaixo.
