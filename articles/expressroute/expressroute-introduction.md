...
## <a name="howtoconnect"></a>Como ligar a minha rede à Microsoft com o ExpressRoute?

Pode criar uma ligação entre a sua rede no local e a nuvem da Microsoft de três formas diferentes:

### Localizado conjuntamente numa troca de nuvem
...
### Opções de largura de banda suportadas
