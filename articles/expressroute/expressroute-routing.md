<properties
   pageTitle="Requisitos de encaminhamento do ExpressRoute | Microsoft Azure"
...
## Endereços IP para peerings

Terá de reservar alguns blocos de endereços IP para configurar o encaminhamento entre a sua rede e routers Enterprise Edge da Microsoft (MSEEs). Esta secção fornece uma lista de requisitos e descreve as regras relativas ao modo como estes endereços IP têm de ser obtidos e utilizados.

### Endereços IP para peering privado do Azure
...
### Endereços IP para o peering público do Azure e o peering da Microsoft
...
| **Região Geopolítica** | **Região do Microsoft Azure** | **Valor das comunidades de BGP** |
|---|---|---|
| **América do Norte** |    |  |
...
>[AZURE.IMPORTANT] Os prefixos globais serão etiquetados com um valor da comunidade adequado e serão anunciados apenas quando o suplemento premium do ExpressRoute estiver ativado.
...
>[AZURE.NOTE] A Microsoft não honra valores das comunidades de BGP definidos por si nas rotas anunciadas para a Microsoft.
