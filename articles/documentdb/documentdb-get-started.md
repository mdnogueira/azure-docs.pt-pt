...
Copie e cole o seguinte código no seu método **GetStartedDemo**, por baixo da criação da base de dados. Esta ação irá criar uma coleção de documentos designada *FamilyCollection*.
