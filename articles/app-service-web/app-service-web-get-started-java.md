...
* O [Azure Toolkit para Eclipse](/azure/azure-toolkit-for-eclipse-installation).
...
* No separador **Plano do serviço de aplicações**:
  ...
  * **Escalão de preço**: selecione a opção gratuita. Para as funcionalidades, veja [Preços do Serviço de Aplicações](https://azure.microsoft.com/pricing/details/app-service/).
