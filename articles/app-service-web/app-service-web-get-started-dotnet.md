<properties 
    pageTitle="Implementar a sua primeira aplicação Web .NET no Azure em cinco minutos | Microsoft Azure" 
...
# Implementar a sua primeira aplicação Web .NET no Azure em cinco minutos
...
4. Implemente o código de exemplo na sua aplicação do Azure tal como emitiria qualquer código com o Git:
    ...
    `git push` não só coloca o código no Azure, mas também restaura os pacotes necessários e cria os binários do ASP.NET. 
