...
> [!NOTE]
> As regras de alerta são uma funcionalidade do Azure. Para obter mais informações, consulte [Receber notificações de alerta](../azure-portal/insights-receive-alert-notifications.md). 
> 
> 
