---
title: "Adicionar funcionalidades à sua primeira aplicação Web"
...
Em [Implementar a sua primeira aplicação Web no Azure em cinco minutos](app-service-web-get-started.md), implementou uma aplicação Web de exemplo no [Serviço de Aplicações do Azure](../app-service/app-service-value-prop-what-is.md). Neste artigo, irá adicionar rapidamente algumas funcionalidades excelentes à sua aplicação Web implementada. Em apenas alguns minutos, irá:
...
## <a name="authenticate-your-users"></a>Autenticar os utilizadores
...
2. Clique em **Adicionar alerta**. Em seguida, na caixa **Recurso**, selecione o recurso que termina com **(serverfarms)**. Este é o seu plano do App Service.  
    ![Alertas – adicionar alerta para o plano do Serviço de Aplicações](./media/app-service-web-get-started/alert-add.png)
