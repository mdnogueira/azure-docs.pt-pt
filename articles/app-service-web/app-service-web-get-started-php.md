---
title: "Implementar a sua primeira aplicação Web PHP no Azure em cinco minutos (CLI 2.0 [Pré-visualização]) | Microsoft Docs"
...
4. Em seguida, obtém o código PHP de exemplo que pretende implementar. Mude para um diretório de trabalho (`CD`) e clone a aplicação de exemplo desta forma:
