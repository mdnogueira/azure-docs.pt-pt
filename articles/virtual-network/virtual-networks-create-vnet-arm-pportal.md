...
description: Saiba como criar uma rede virtual com o portal do Azure no ARM | Resource Manager.
...
Este documento abrange a criação de uma VNet com o modelo de implementação do Resource Manager. Também pode [criar uma rede virtual no modelo de implementação clássica com o portal de pré-visualização do Azure](virtual-networks-create-vnet-classic-pportal.md).
