...
Depois de duas redes virtuais serem colocadas em modo de peering, os recursos em cada uma destas podem ligar-se diretamente a recursos na rede virtual em modo de peering. Estas duas redes virtuais têm conectividade completa ao nível de IP.
