...
Estamos a trabalhar para atualizar o Gestor de ligações híbridas para corrigir este problema. Para soluções, consulte [erro de ligações híbridas com o SQL Server: System.OverflowException: operação aritmética resultou numa capacidade excedida](https://blogs.msdn.microsoft.com/waws/2016/05/17/hybrid-connection-error-with-sql-server-system-overflowexception-arithmetic-operation-resulted-in-an-overflow/).
