...
Neste cenário, ficará a saber como criar um grupo de recursos, o plano do app service do Linux e a aplicação web e implementar uma aplicação ASP.NET Core utilizar um contentor de Docker.
