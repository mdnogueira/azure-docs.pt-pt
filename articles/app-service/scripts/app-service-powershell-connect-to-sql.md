---
title: "Script do PowerShell do Azure de exemplo - ligar uma aplicação web numa base de dados SQL | Microsoft Docs"
description: "Script do PowerShell do Azure de exemplo - ligar uma aplicação web numa base de dados do SQL Server"
...
| [Novo AzureRMSQLServer](/powershell/module/azurerm.sql/new-azurermsqlserver) | Cria um servidor de base de dados SQL. |
...
| [Novo-AzureRMSQLDatabase](/powershell/module/azurerm.sql/new-azurermsqldatabase) | Cria uma base de dados ou uma base de dados elástica. |
