...
Fornecer dados transformados da cloud para origens no local, como o SQL Server, ou manter esses dados nas origens de armazenamento na cloud para serem consumidos pelas ferramentas de business intelligence (BI), por ferramentas de análise e por outras aplicações.
