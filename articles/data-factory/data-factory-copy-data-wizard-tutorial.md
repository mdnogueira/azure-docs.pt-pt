---
title: 'Tutorial: Criar um pipeline com o Assistente de Cópia'
...
3. No painel **Nova fábrica de dados**, repare que a opção **Adicionar ao Startboard** está selecionada.
4. Clique em **Criar** no painel **Nova fábrica de dados**.
   ...
   > 
   > 
5. Clique no hub **NOTIFICAÇÕES** à esquerda e procure notificações do processo de criação. Clique em **X** para fechar o painel **NOTIFICAÇÕES** se estiver aberto. 
6. Após concluir a criação, verá o painel **DATA FACTORY**, conforme apresentado na imagem seguinte:
...
14. Na página **Implementação com êxito**, clique na ligação: **Clicar aqui para monitorizar o pipeline de cópia**.
...
15. Siga as instruções em [Monitorizar e gerir o pipeline com a Aplicação de Monitorização](data-factory-monitor-manage-app.md) para saber como monitorizar o pipeline que acabou de criar. Clique no ícone **Atualizar** na lista **JANELAS DE ATIVIDADE** para ver o setor. 
