...
1. Leia o artigo [Descrição Geral de Tutorial](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md).
    
    > [AZURE.IMPORTANT] Preencha os pré-requisitos antes de avançar. 
