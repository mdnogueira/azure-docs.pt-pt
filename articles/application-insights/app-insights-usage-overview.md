...
3. **Código de aplicação móvel:** utilizar o SDK do System Center Mobile para recolher eventos a partir da sua aplicação, em seguida, envie cópias destes eventos para o Application Insights para análise pelo [seguir este guia](app-insights-mobile-center-quickstart.md).
