...
* **[Analisar a utilização de aplicações móveis](app-insights-mobile-center-quickstart.md)**  através da integração com o Visual Studio Mobile Center.
