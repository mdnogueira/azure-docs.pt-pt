...
4. Localize a chave de instrumentação do novo recurso. Terá de colar esta chave no seu projeto de código em breve.
...
#### Se estiver a utilizar o Spring Web MVC 3.1 ou posterior
