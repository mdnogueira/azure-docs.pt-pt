...
## Aplicação de exemplo instrumentada com o Application Insights
...
### Separar o desenvolvimento, os testes e a produção
...
## Ver eventos de Diagnóstico do Azure
...
## Acompanhar pedidos de funções de trabalho
...
## Exceção “método não encontrado” ao executar nos Serviços Cloud do Azure
