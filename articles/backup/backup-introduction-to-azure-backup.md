...
> [!WARNING]
> A eliminação de duplicados não está disponível no Azure em qualquer um dos componentes de Cópia de segurança. Quando o System Center DPM e o Servidor do Backup são implementados no Azure, não é possível eliminar os discos de armazenamento ligados à VM duplicados.
> 
> 
...
> [!WARNING]
> Apenas o cliente possui a chave utilizada para encriptar os dados de cópia de segurança. A Microsoft não mantém uma cópia no Azure e não tem qualquer acesso à chave. Se a chave está no local incorreto, a Microsoft não pode recuperar os dados de cópia de segurança.
> 
> 
