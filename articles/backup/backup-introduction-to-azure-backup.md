...
# Descrição geral das funcionalidades do Azure Backup
...
## Que componentes do Azure Backup devo utilizar?
...
## Quais são os cenários de implementação para cada componente?
...
## Utilizar VMs de Armazenamento Premium com o Azure Backup
...
## Utilizar VMs de disco gerido com o Azure Backup
...
### Cópia de segurança de VMs de disco gerido
...
## Quais são as funcionalidades de cada componente do Backup?
...
#### Eliminação de Discos Duplicados
...
### A cópia de segurança incremental explicada
...
#### Comparação entre cópias de segurança Completas, Diferenciais e Incrementais
