---
title: "Manter os ficheiros na Shell de nuvem do Azure (pré-visualização) | Microsoft Docs"
...
## <a name="how-cloud-shell-works"></a>Como funciona a Shell de nuvem
Shell de nuvem persiste ficheiros através do método seguinte: 
