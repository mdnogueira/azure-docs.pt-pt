...
# Base de Dados do Azure para MySQL: utilizar o PHP para se ligar e consultar dados
...
## Pré-requisitos
Este guia de início rápido utiliza os recursos criados em qualquer um desses guias como ponto de partida:
