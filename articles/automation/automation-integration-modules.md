<properties
   pageTitle="Criar um Módulo de Integração da Automatização do Azure | Microsoft Azure"
...
- Para saber mais sobre a criação de Módulos do PowerShell, consulte o artigo [Escrever um Módulo do Windows PowerShell](https://msdn.microsoft.com/library/dd878310(v=vs.85).aspx)
