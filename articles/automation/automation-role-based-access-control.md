...
>[AZURE.NOTE] Não é possível conceder direitos de acesso a um runbook ou runbooks específicos, apenas para os recursos e ações na conta de Automatização.  
...
1. Clique em **Funções** a partir do painel de Utilizadores para abrir o **painel Funções**. A partir deste painel, pode ver o nome da função, o número de utilizadores e os grupos atribuídos a essa função.
