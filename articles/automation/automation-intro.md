<properties
    pageTitle="O que é a Automatização do Azure | Microsoft Azure"
...
## Automatizar processos com runbooks
...
## O que podem automatizar os runbooks?
...
## Obter runbooks a partir da comunidade
...
## Criar Runbooks com a Automatização do Azure 
...
## Gestão da configuração da automatização com a Configuração de Estado Pretendido 
...
## Criar as suas configurações do DSC com a Automatização do Azure
...
## Aplicações práticas de exemplo da Automatização do Azure 
...
## Como é que a Automatização do Azure se relaciona com outras ferramentas de automatização?
