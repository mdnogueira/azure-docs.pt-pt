...
* [Configurar a replicação do HBase no HDInsight](hdinsight-hbase-replication.md): Saiba como configurar a replicação do HBase entre dois centros de dados do Azure.
