...
* [Provision HDInsight clusters on Azure Virtual Network (Aprovisonar clusters do HDInsight na Azure Virtual Network)][hbase-provision-vnet]
...
## <a name="a-namesee-alsoasee-also"></a><a name="see-also"></a>Ver também
