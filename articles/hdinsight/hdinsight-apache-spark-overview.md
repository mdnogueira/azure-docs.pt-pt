<properties 
    pageTitle="Uma descrição geral do Apache Spark no HDInsight | Microsoft Azure" 
...
>[AZURE.NOTE] Para obter uma lista de limitações e problemas conhecidos da versão atual, consulte [Problemas conhecidos do Apache Spark no Azure HDInsight (Linux)](hdinsight-apache-spark-jupyter-spark-sql.md).
