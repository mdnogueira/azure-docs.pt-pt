...
---
# <a name="use-mirrormaker-to-replicate-apache-kafka-topics-with-kafka-on-hdinsight-preview"></a>Utilizar MirrorMaker para replicar tópicos Kafka do Apache com Kafka no HDInsight (pré-visualização)
