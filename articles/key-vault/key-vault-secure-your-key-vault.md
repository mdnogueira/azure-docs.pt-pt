...
### <a name="rolebased-access-control-rbac"></a>Controlo de Acesso Baseado em Funções (RBAC)
...
* [Compreender a implementação do Resource Manager e a implementação clássica](../resource-manager-deployment-model.md)
