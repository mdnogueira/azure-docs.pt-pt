...
>
> Este tutorial utiliza o CLI 2.0 mais recente do Azure.
>
>
...
O primeiro parâmetro é o nome do grupo de recursos e o segundo parâmetro é a localização. Para a localização, utilize o comando `az account list-locations` para identificar como especificar uma localização alternativa neste exemplo. Se precisar de mais informações, escreva: `az account list-locations -h`.
...
* Para ver a sua chave, escreva: `az keyvault key list --vault-name 'ContosoKeyVault'`
* Para ver o seu segredo, escreva: `az keyvault secret list --vault-name 'ContosoKeyVault'`
...
2. No lado esquerdo, clique em **do Azure Active Directory**e, em seguida, selecione o diretório no qual irá registar a sua aplicação. <br> <br> 
...
lista de chaves de keyvault AZ – nome do cofre 'ContosoKeyVault'

Este comando apresenta uma lista completa das propriedades para a chave especificada:

chave de keyvault AZ Mostrar – nome do cofre 'ContosoKeyVault –' name 'ContosoFirstKey'

Este comando lista uma tabela de apresentação de todos os nomes secretos e propriedades selecionadas:

lista de secreta keyvault AZ--nome do cofre 'ContosoKeyVault'

Eis um exemplo de como remover uma chave específica:

eliminar a chave de keyvault AZ – nome do cofre 'ContosoKeyVault –' name 'ContosoFirstKey'

Eis um exemplo de como remover um segredo específico:

eliminar o segredo de keyvault AZ – nome do cofre 'ContosoKeyVault –' name 'SQLPassword'
