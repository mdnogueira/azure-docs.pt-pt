...
###6.   Implementar o Balanceador de Carga Interno (Internal Load Balancer, ILB)
...
###8.   Implementar o Balanceador de Carga com Acesso à Internet (Público)
...
>[AZURE.NOTE] Se a autenticação de certificado de utilizador cliente (autenticação clientTLS com certificados de utilizador X509) for necessária, o AD FS requer que a porta TCP 49443 esteja ativada para acesso de entrada.

###10.  Testar o início de sessão do AD FS
