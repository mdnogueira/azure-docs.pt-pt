...
> [!NOTE]
> Subscrições do Office 365 ou licenças do Azure Active Directory (por exemplo: o acesso ao Azure Active Directory) aprovisionado a partir do Office 365 portal não se qualificam para utilizar o RBAC.
