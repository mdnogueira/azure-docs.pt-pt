...
Antes de configurar e ativar o serviço de aprovisionamento, tem de decidir quais os utilizadores e/ou grupos no Azure AD representam os utilizadores que necessitam de aceder à sua aplicação Salesforce Sandbox. Depois de decidir, pode atribuir estes utilizadores à sua aplicação Salesforce Sandbox ao seguir as instruções aqui:
...
6. Para obter token de segurança do Salesforce Sandbox, abra um novo separador e iniciar sessão na mesma conta de administrador do Salesforce Sandbox. No canto superior direito da página, clique em seu nome e, em seguida, clique em **as minhas definições**.
...
8. No **repor o meu Token de segurança** página, clique em de **repor o Token de segurança** botão.
