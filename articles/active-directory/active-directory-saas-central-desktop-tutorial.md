...
7.  En el panel de resultados, seleccione **Central Desktop** y, a continuación, haga clic en **Completar** para agregar la aplicación.
...
2.  En la página **¿Cómo desea que los usuarios inicien sesión en Central Desktop?**, seleccione **Inicio de sesión único de Microsoft Azure AD** y, a continuación, haga clic en **Siguiente**.
...
4.  En la página **Configuración de inicio de sesión único en Central Desktop**, para descargar el certificado, haga clic en **Descargar certificado** y, a continuación, guarde el archivo de certificado en el equipo.
...
6.  Vaya a **Settings** (configuración) haga clic en **Advanced** (avanzadas) y, a continuación, haga clic en **Single Sign On** (inicio de sesión único).
...
7.  En la página **Single Sign On Settings** (configuración de inicio de sesión único), siga estos pasos:
    ...
    2.  En el Portal de Azure AD, en la página **Configurar inicio de sesión único en Central Desktop**, copie el valor de **Issuer URL** (dirección URL del emisor) y péguelo en el cuadro de texto **SSO URL** (dirección URL de SSO).
    3.  En el Portal de Azure AD, en la página **Configurar inicio de sesión único en Central Desktop**, copie el valor de **Dirección URL de inicio de sesión remoto** y péguelo en el cuadro de texto **SSO Login URL (dirección URL de inicio de sesión SSO)**.
    4.  En el Portal de Azure AD, en la página **Configurar inicio de sesión único en Central Desktop**, copie el valor de **Dirección URL del servicio de cierre de sesión único** y péguelo en el cuadro de texto **SSO Logout URL** (dirección URL de cierre de sesión SSO).

8.  En la sección **Message Signature Verification Method** (método de autenticación de firma de mensaje), realice los pasos siguientes:
    ...
    1.  Seleccione **Certificate** (certificado).
    2.  En la lista **SSO Certificate** (certificado SSO), seleccione **RSH SHA256**.
    ...
    4.  Seleccione **Display a link to your SAMLv2 login page** (Mostrar un vínculo a la página de inicio de sesión SAMLv2).
...
2.  Vaya a **People > Internal Members** (Contactos > Miembros internos).

3.  Haga clic en **Add Internal Members** (agregar miembros internos).

    ![Contactos](./media/active-directory-saas-central-desktop-tutorial/IC781051.png "Contactos")

4.  En el cuadro de texto **Email Address of New Members** (dirección de correo electrónico de nuevos miembros) escriba una cuenta AAD que quiera aprovisionar y luego haga clic en **Next** (siguiente).
...
5.  Haga clic en **Add Internal Member(s)** (agregar miembros internos).
...
<!--Please, PASS changes in lines 52-54-->