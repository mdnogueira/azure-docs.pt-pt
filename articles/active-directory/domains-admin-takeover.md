...
7. Selecione **nomes de domínio**, em seguida, adicione o nome de domínio. Terá de introduzir os registos TXT de DNS para verificar a propriedade do nome de domínio. 
