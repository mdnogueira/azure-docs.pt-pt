---
title: "Resolver o problema “Não pode aceder aí a partir daqui” no portal do Azure num dispositivo Windows | Microsoft Docs"
...
---
# <a name="troubleshooting-you-cant-get-there-from-here-on-a-windows-device"></a>Resolver o problema “Não pode aceder aí a partir daqui” num dispositivo Windows
...
A única remediação é utilizar um browser que a aplicação suporte na plataforma do seu dispositivo. Para obter uma lista completa dos browsers suportados, veja os [browsers suportados](active-directory-conditional-access-supported-apps.md#supported-browsers).  
