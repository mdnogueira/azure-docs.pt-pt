...
> [AZURE.NOTE] É recomendado que transfira e instale ou atualize para o módulo do Azure PowerShell mais recente.
...
> [AZURE.IMPORTANT] O nome da partilha de ficheiros tem de ser todo em minúsculas. Para obter detalhes completos sobre a nomenclatura de partilhas de ficheiros e ficheiros, consulte o artigo [Nomenclatura e Referência de Partilhas, Diretórios, Ficheiros e Metadados](https://msdn.microsoft.com/library/azure/dn167011.aspx).
...
> [AZURE.NOTE] A versão mais recente do emulador do Storage do Azure não suporta o File Storage. A sua cadeia de ligação tem de visar uma conta do Storage do Azure na nuvem para funcionar com o File Storage.
...
> [AZURE.NOTE] Se estiver a copiar um blob para um ficheiro ou um ficheiro para um blob, tem de utilizar uma assinatura de acesso partilhado (SAS) para autenticar o objeto de origem, mesmo se estiver a copiar dentro da mesma conta do Storage.
