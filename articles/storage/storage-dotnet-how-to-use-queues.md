...
## Utilizar o padrão Async-Await com APIs de Armazenamento de filas comuns
...
## Tirar maior partido das opções adicionais para remover as mensagens da fila
...
- Saiba como simplificar o código de escrita para trabalhar com o Storage do Azure utilizando o [SDK de WebJobs do Azure](../app-service-web/websites-dotnet-webjobs-sdk.md).
- Ver mais guias de funcionalidades para saber mais sobre as opções adicionais para armazenar dados no Azure.
    - [Introdução ao Table Storage do Azure utilizando o .NET](storage-dotnet-how-to-use-tables.md) para armazenar dados estruturados.
