...
2. **Clique no botão Adicionar Partilha de Ficheiros**:    
    ![Clique no botão adicionar partilha de ficheiros](media/storage-file-how-to-create-file-share/create-file-share-portal2.png)

3. **Indique o Nome e a Quota. Atualmente, a quota pode ter um máximo de 5 TB**:    
    ![Indique um nome e uma quota pretendida para a partilha de ficheiros nova](media/storage-file-how-to-create-file-share/create-file-share-portal3.png)
