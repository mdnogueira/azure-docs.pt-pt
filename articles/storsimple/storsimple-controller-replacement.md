...
description: "Explica como remover e substitua um ou ambos os módulos de controlador no dispositivo StorSimple."
services: storsimple
documentationcenter: 
author: alkohli
manager: timlt
...
> [!IMPORTANT]
> Antes de remover e de substituir um controlador, reveja as informações de segurança no [substituição de componente de hardware do StorSimple](storsimple-hardware-component-replacement.md).
> 
> 
...
1. Do Azure portal clássico, aceda ao serviço StorSimple Manager, clique em de **dispositivos** separador e, em seguida, clique no nome do dispositivo que pretende monitorizar.
2. Aceda a **manutenção > Estado do Hardware**. O estado do controlador 0 ou 1 controlador deve ser vermelho, que indica uma falha.
...
8. Depois de reinicia o controlador, verifique o **Estado controlador** e **estado do Cluster** no portal clássico do Azure para verificar se o controlador é para um bom estado de funcionamento e está no modo de espera.
...
4. Terminar quando o bloqueio temporário ajusta no local. O **OK** LED agora deve estar no.  
   ...
   > 
   > 
5. Para verificar que a substituição é efetuada com êxito, no portal clássico do Azure, aceda ao **dispositivos** > **manutenção** > **estado do Hardware**, e Certifique-se de que o controlador 0 e o controlador 1 estão em bom Estados (estado está verde).
...
* [Utilize o portal clássico do Azure para identificar o controlador de Active Directory](#use-the-azure-classic-portal-to-identify-the-active-controller)
...
### <a name="use-the-azure-classic-portal-to-identify-the-active-controller"></a>Utilize o portal clássico do Azure para identificar o controlador de Active Directory
No portal clássico do Azure, navegue para **dispositivos** > **manutenção**e desloque-se para o **controladores** secção. Aqui pode verificar que controlador está ativo.

![Identificar o controlador de Active Directory no portal clássico do Azure](./media/storsimple-controller-replacement/IC752072.png)

**Figura 6** portal clássico do Azure que mostra o controlador de Active Directory
