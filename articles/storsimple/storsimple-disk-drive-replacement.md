---
title: Substituir uma unidade de disco num dispositivo StorSimple | Microsoft Docs
...
> [!IMPORTANT]
> Antes de remover e de substituir uma unidade de disco, reveja as informações de segurança no [substituição de componente de hardware do StorSimple](storsimple-hardware-component-replacement.md).
> 
> 
...
> * No portal clássico do Azure, ranhuras são numeradas da 0 – 11. Por conseguinte, se o portal mostra que um disco na ranhura 2 falhou, no dispositivo, procure o disco com falhas na ranhura de terceiro da parte superior esquerda.
> 
> 
...
1. Para identificar o disco com falhas, no portal clássico do Azure, aceda a **dispositivos** > **manutenção** > **estado do Hardware**. Porque um disco pode falhar no bastidor primário e/ou um bastidor EBOD (se estiver a utilizar um modelo de 8600), ver o estado dos discos em **partilhado componentes** e, em **EBOD bastidor partilhado componentes**. Um disco com falhas em qualquer um dos bastidor será apresentado com um estado vermelho.
...
5. Certifique-se de que a substituição foi concluída com êxito e a unidade está operacional, aceder ao portal clássico do Azure e navegar até **manutenção** > **estado do Hardware**. Em **partilhado componentes** ou **EBOD bastidor partilhado componentes**, o estado da unidade deve estar verde, indicando que está em bom estado.
