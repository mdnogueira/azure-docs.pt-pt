...
#### [Utilizar o Windows PowerShell no StorSimple](storsimple-8000-windows-powershell-administration.md)
...
#### [Instalar Atualização 4 - atual](storsimple-8000-install-update-4.md)
...
#### [Instalar a Atualização 4 - atual (portal do Azure)](storsimple-8000-install-update-4.md)

#### [Instalar a Atualização 4 (clássico)](storsimple-install-update-4.md)
