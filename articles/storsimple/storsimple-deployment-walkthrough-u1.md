<properties 
   pageTitle="Implementar o dispositivo StorSimple (Atualização 1) | Microsoft Azure"
...
|   |   |  |  |
| **Criar um contentor de volume**                      | Nome do contentor de volume:                            | Nome do contentor                                                                                                                                                 |        |
...
> [AZURE.NOTE] O MPIO não é suportado num dispositivo virtual StorSimple. 
