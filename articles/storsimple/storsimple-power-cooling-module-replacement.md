---
title: Substituir um PCM no dispositivo StorSimple | Microsoft Docs
...
> [!IMPORTANT]
> Antes de remover e de substituir um PCM, reveja as informações de segurança no [substituição de componente de hardware do StorSimple](storsimple-hardware-component-replacement.md).
> 
> 
...
1. No portal clássico do Azure, clique em **dispositivos** > **manutenção** > **estado do Hardware**. Verificar o estado dos componentes PCM em **partilhado componentes** para identificar que PCM falhou:
...
7. Ative o PCM.
8. Certifique-se de que a substituição foi concluída com êxito: no portal clássico do Azure do seu serviço StorSimple Manager, navegue para **dispositivos** > **manutenção** > **estado do Hardware**. Em **partilhado componentes**, o estado do PCM deve estar verde. 
