...
## <a name="create-a-public-ip-address-for-the-frontend-configuration"></a>Criar um endereço IP público para a configuração de front-end
...
## <a name="create-an-application-gateway-by-using-newazurermapplicationgateway"></a>Criar um gateway de aplicação com New-AzureRmApplicationGateway
