<properties 
    pageTitle="Guia de Introdução do Azure Mobile Engagement com Melhores Práticas"
...
## Passo 1: definir os KPIs para se ajustarem ao modelo BET
...
#### Exercício 1 do Manual: Criar o dashboard de KPI
...
## Passo 2: o Seu Programa de Envolvimento
...
###### Quem: o segmento de utilizadores que irá receber as mensagens
...
###### O Quê: a mensagem que vai enviar
...
>[AZURE.NOTE] Certifique-se de que o conteúdo que está a enviar como notificações push está em conformidade com as diretrizes da respetiva plataforma (iOS, Android, Windows) no que diz respeito à programação de aplicações e ao envio de notificações push.

 


###### Quando: o período de tempo da sua campanha
...
#### Exercício 2 do Manual: criar o seu programa de envolvimento
...
## Passo 3: integração de aplicações


#### Criar um plano de etiquetas
...
#### Integração de etiquetas e do SDK 
...
#### Testes de aceitação de utilizadores (UAT)
...
Configurar o Azure Mobile Engagement é muito simples. Toda a documentação relacionada com a interface de utilizador está disponível no site do Azure Mobile Engagement, [Como navegar na interface de utilizador](mobile-engagement-user-interface.md).
