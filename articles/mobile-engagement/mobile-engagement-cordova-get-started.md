...
+ [Plug-in de Mobile Engagement Cordova](https://www.npmjs.com/package/cordova-plugin-ms-azure-mobile-engagement)

> [AZURE.NOTE] Pode encontrar o código de origem e o ficheiro Leia-me para o plug-in Cordova na [Github](https://github.com/Azure/azure-mobile-engagement-cordova)
...
###Configurar as credenciais de Push para Mobile Engagement
...
###Ativar as notificações push na aplicação Cordova
...
[Descrição geral de todos os métodos disponíveis com o SDK do Mobile Engagement Cordova](https://github.com/Azure/azure-mobile-engagement-cordova)
