<properties
    pageTitle="Introdução ao Azure Mobile Engagement para Aplicações Universais do Windows"
...
###Permitir que a aplicação receba Notificações Push do WNS
...
3. Quando a aplicação tiver sido criada, navegue para **Serviços -> Notificações push** no menu à esquerda.
...
5. Será direcionado para a secção Credenciais de push. Certifique-se de que está a utilizar a secção **Definições da Aplicação** e, em seguida, copie o **SID do Pacote** e o **Segredo do cliente**
...
[Aplicações Universal do Windows – Integração de sobreposição]: ../mobile-engagement-windows-store-integrate-engagement-reach/#overlay-integration
