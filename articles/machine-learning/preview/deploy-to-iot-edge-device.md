...
---
# <a name="deploy-and-azure-machine-learning-model-to-an-azure-iot-edge-device"></a>Implementar e modelo do Azure Machine Learning para um dispositivo de limite de IoT do Azure
