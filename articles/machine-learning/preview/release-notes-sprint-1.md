...
- Utilizador pode agora criar um ambiente de implementação com acesso de proprietário apenas a um grupo de recursos do Azure. Já não é necessário acesso de proprietário para a subscrição completa.
