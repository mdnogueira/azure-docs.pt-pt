...
### [Ver cenários de exemplo](machine-learning-data-science-plan-sample-scenarios.md)
## Ferramentas e utilitários
### [Ambientes de configuração](machine-learning-data-science-environment-setup.md)
...
#### [Configuração da VM do Azure](machine-learning-data-science-setup-virtual-machine.md)
#### [Configuração da VM do SQL](machine-learning-data-science-setup-sql-server-virtual-machine.md)
...
#### [Criar uma área de trabalho](machine-learning-create-workspace.md)
#### [Gerir uma área de trabalho](machine-learning-manage-workspace.md)
...
#### [Utilizar tabelas de partição do SQL](machine-learning-data-science-parallel-load-sql-partitioned-tables.md)
...
##### [Utilizar o armazenamento de blobs](machine-learning-data-science-sample-data-blob.md)
...
#### [Descrição geral do TDSP](machine-learning-data-science-select-features.md)
...
##### [Utilizar regressão linear](machine-learning-linear-regression-in-azure.md)
##### [Utilizar análise de texto](machine-learning-text-analytics-module-tutorial.md)
##### [Referência do algoritmo](https://msdn.microsoft.com/library/azure/dn905974.aspx)
...
#### [Reenviar programaticamente](machine-learning-retrain-models-programmatically.md)
...
## [Descrição geral do PowerShell](machine-learning-powershell-module.md)
