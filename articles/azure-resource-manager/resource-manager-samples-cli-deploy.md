---
title: Script CLI do Azure de exemplo - implementar a modelo | Microsoft Docs
...
---
# <a name="azure-resource-manager-template-deployment---azure-cli-script"></a>Implementação de modelo do Azure Resource Manager - script da CLI do Azure
...
| Comando | Notas |
|---|---|
| [grupo de AZ existe](/cli/azure/group#exists) | Verifica se o grupo de recursos existe. |
| [Criar grupo AZ](/cli/azure/group#create) | Cria um grupo de recursos na qual todos os recursos são armazenados. |
| [Criar implementação do grupo AZ](/cli/azure/group/deployment#create) | Inicie uma implementação.  |
| [eliminação do grupo de AZ](/cli/azure/group#delete) | Elimina um grupo de recursos, incluindo todos os respetivos recursos. |
