...
## [Serviços suportados](resource-manager-supported-services.md)
...
### [Publicar aplicação gerida](managed-application-publishing.md)
### [Consumir aplicação gerida](managed-application-consumption.md)
