---
title: Como realizar uma transmissão em fluxo em direto com codificadores no local através do Portal do Azure | Microsoft Docs
...
2. Clique em **Criação Rápida** para criar um canal pass-through com o protocolo de inserção RTMP.
   
    A janela **CRIAR UM NOVO CANAL** é apresentada.
3. Dê um nome ao novo canal e clique em **Criar**. 
