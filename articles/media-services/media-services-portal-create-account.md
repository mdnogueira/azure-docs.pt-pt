...
3. Em **CRIAR CONTA DE MEDIA SERVICES**, Introduza os valores necessários.
   ...
   3. Em **Grupo de Recursos**, selecione o recurso novo ou existente.  Um grupo de recursos é uma coleção de recursos que partilham o ciclo de vida, as permissões e as políticas. Sabia mais [aqui](../resource-group-overview.md#resource-groups).
