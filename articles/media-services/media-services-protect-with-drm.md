...
2. Utilize NuGet para instalar e adicionar SDK .NET de Media Services do Azure.
3. Adicione referências adicionais: System.Configuration.
4. Adicione o ficheiro de configuração que contém o nome da conta e as informações da chave:
