...
2. Crie um elemento.
3. Se pretender que o elemento seja encriptado dinamicamente durante a reprodução, faça o seguinte:
...
3. Crie um programa e especifique a utilização do elemento que criou.
1. Publique o elemento associado ao programa através da criação de um localizador OnDemand.
...
1. Obtenha o ponto final (entrada) de inserção dos canais. Este ponto final deve ser fornecido ao codificador que pode enviar uma transmissão em fluxo em direto única.
1. Obtenha o ponto final de pré-visualização. Este ponto final é utilizado para pré-visualizar a transmissão.
1. Crie um elemento que será utilizado para armazenar o conteúdo. As políticas de entrega de elementos também devem ser configuradas, conforme exibido neste exemplo.
1. Crie um programa e especifique-o para que utilize o elemento criado anteriormente. Inicie o programa. São utilizadas APIs de execução longa.
1. Crie um localizador para o elemento, permitindo que o conteúdo seja publicado e possa ser transmitido para os seus clientes.
1. Mostre e oculte imagens fixas. Inicie e pare os anúncios. São utilizadas APIs de execução longa.
1. Limpe o canal e todos os recursos associados.
...
1. Adicione o SDK .NET dos Media Services à aplicação da consola utilizando o pacote NuGet dos Media Services.
...
>[AZURE.NOTE]Para localizar os valores do Nome e da Chave, aceda ao Portal Clássico do Azure, selecione a conta Serviço de Multimédia e clique no ícone “GERIR CHAVES” na parte inferior da janela do portal. Clicar no ícone junto a cada caixa de texto copia o valor para a área de transferência do sistema.
