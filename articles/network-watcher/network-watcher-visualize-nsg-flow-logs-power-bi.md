...
Saiba como visualizar os seus registos de fluxo NSG com a pilha de Elastick, visitando [visualizar padrões de tráfego de rede de e para as suas VMs utilizando ferramentas open source](network-watcher-using-open-source-tools.md)
