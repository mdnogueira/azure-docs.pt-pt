...
## [Visualizar registos de fluxos no Azure com o Graylog](network-watcher-analyze-nsg-flow-logs-graylog.md)
...
## [Analisar os registos de fluxo com o Observador de Rede e o Grafana](network-watcher-nsg-grafana.md)
# Referência
