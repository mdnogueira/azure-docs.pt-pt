...
## <a name="sitetosite-and-multisite"></a>Site a Site e Multilocal
...
### <a name="deployment-models-and-methods-for-sitetosite-and-multisite"></a>Métodos de implementação e métodos de Site para Site e Multilocal
...
### <a name="deployment-models-and-methods-for-vnettovnet"></a>Modelos de implementação e métodos para VNet para VNet
...
### <a name="deployment-models-and-methods-for-pointtosite"></a>Métodos e modelos de implementação de Ponto para Site
...
## <a name="sitetosite-and-expressroute-coexisting-connections"></a>Ligações Site a Site e ExpressRoute coexistentes
