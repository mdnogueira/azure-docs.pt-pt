...
## <a name="subnets"></a>2. Adicionar sub-redes e espaços de endereços adicionais
...
## <a name="CreateConnection"></a>8. Criar uma ligação de Rede de VPNs
...
## <a name="VerifyConnection"></a>9. Verificar a ligação VPN
