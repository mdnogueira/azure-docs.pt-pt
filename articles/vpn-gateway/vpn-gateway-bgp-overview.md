...
> [!IMPORTANT]
> Atualmente, será bloqueado publicitar aos gateways de VPN do Azure a rota predefinida (0.0.0.0/0). Será fornecida uma atualização adicional assim que esta capacidade for disponibilizada.
> 
> 
