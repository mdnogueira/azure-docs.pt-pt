...
# Aplicação .NET híbrida no local/nuvem utilizando o reencaminhamento do Service Bus do Azure
...
-   Como utilizar o reencaminhamento do Service Bus do Azure para partilhar dados entre uma aplicação do Azure e um serviço Web alojado noutro local.
...
1.  Caso não esteja ainda aberto, reabra no Visual Studio o projeto **ProductsPortal** criado na secção "Criar uma aplicação ASP.NET".
...
7.  No Explorador de Soluções, clique com o botão direito na solução **ProductsPortal**, clique em **Adicionar** e, de seguida, em **Projeto Existente**.
...
3. Na coluna do lado esquerdo, clique em **Web**.
