...
1. Em seguida, crie uma função que aceite e armazene o espaço de nomes de serviço e a chave SAS. Adicione este método fora de `Main()`. Por exemplo: 
