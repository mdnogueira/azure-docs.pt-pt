...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Introdução ao Servidor Multi-Factor Authentication do Azure
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Transferir o Servidor Multi-Factor Authentication do Azure
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>Para transferir o Servidor Multi-Factor Authentication do Azure a partir do portal do Azure
- - -
...
### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>Para transferir o Servidor Multi-Factor Authentication do Azure através das definições de serviço
1. Inicie sessão no Portal do Azure como Administrador.
2. No lado esquerdo, selecione Active Directory.
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Instalar e Configurar o Servidor Multi-Factor Authentication do Azure
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Requisitos da firewall do Servidor Multi-Factor Authentication do Azure
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>Para instalar e configurar o servidor Multi-Factor Authentication do Azure
- - -
...
### <a name="to-import-users-from-active-directory"></a>Para importar utilizadores do Active Directory
- - -
...
## <a name="send-users-an-email"></a>Enviar um e-mail aos utilizadores
...
### <a name="configuring-email-and-email-templates"></a>Configurar e-mail e modelos de e-mail
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Como o Servidor Multi-Factor Authentication do Azure gere dados de utilização
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Configurações Avançadas do Servidor Multi-Factor Authentication do Azure
