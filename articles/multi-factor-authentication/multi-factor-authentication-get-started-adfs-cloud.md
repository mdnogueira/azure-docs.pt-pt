...
---
# <a name="securing-cloud-resources-with-azure-multifactor-authentication-and-ad-fs"></a>Proteger recursos da nuvem com o Multi-Factor Authentication do Azure e o AD FS
...
1. Utilize os passos descritos em [Ativar o Multi-Factor Authentication para os utilizadores](multi-factor-authentication-get-started-cloud.md#turn-on-multi-factor-authentication-for-users) para ativar uma conta.
...
### <a name="configure-azure-multifactor-authentication-trusted-ips-with-federated-users"></a>Configurar IPs Fidedignos do Multi-Factor Authentication do Azure com Utilizadores Federados
