...
* *Comando e controlo*: Enviar mensagens para um dispositivo a partir da cloud para que o dispositivo execute uma ação.
...
Quando um dispositivo é ligado pela primeira vez ao Hub IoT na solução pré-configurada, envia uma mensagem informativa do dispositivo para o hub, que enumera os comandos aos quais o dispositivo pode responder. Na solução pré-configurada de monitorização remota, os dispositivos simulados suportam estes comandos:
