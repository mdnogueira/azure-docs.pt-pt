...
* Se eliminar o grupo de recursos no [portal do Azure][lnk-azure-portal], apenas estará a eliminar os recursos nesse grupo de recursos. Também terá de eliminar a aplicação do Azure Active Directory associada à solução pré-configurada no [portal clássico do Azure][lnk-classic-portal].
