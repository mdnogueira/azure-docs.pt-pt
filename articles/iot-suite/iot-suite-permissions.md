...
> [!NOTE]
> Se continuar a ver o erro depois de confirmar que é administrador global no inquilino do AAD e coadministrador na subscrição, solicite ao administrador de conta que remova o utilizador e atribua novamente as permissões necessárias pela seguinte ordem: adicionar o utilizador como administrador global e, em seguida, adicionar o utilizador como coadministrador na subscrição do Azure. Se os problemas persistirem, contacte [Ajuda e Suporte][lnk-help-support].
> 
> 
