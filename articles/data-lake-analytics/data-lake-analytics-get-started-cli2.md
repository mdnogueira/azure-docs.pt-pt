...
---
# <a name="tutorial-get-started-with-azure-data-lake-analytics-using-azure-cli-20-preview"></a>Tutorial: introdução ao Azure Data Lake Analytics com a CLI 2.0 do Azure (Pré-visualização)
[!INCLUDE [get-started-selector](../../includes/data-lake-analytics-selector-get-started.md)]

Saiba como utilizar a CLI 2.0 do Azure para criar contas de Análise do Azure Data Lake, definir as tarefas de Data Lake Analytics em [U-SQL](data-lake-analytics-u-sql-get-started.md) e submeter as tarefas para contas de Data Lake Analytics. Para mais informações sobre a Data Lake Analytics, consulte [Descrição geral da Análise do Azure Data Lake](data-lake-analytics-overview.md).
...
* **Ative a Pré-visualização da CLI 2.0 do Data Lake Store/Analytics**. A CLI 2.0 do Data Lake Store e do Data Lake Analytics ainda está em Pré-visualização. Execute os seguintes comandos para ativar ambos:
...
* **Grupo de Recursos do Azure**. Uma conta de Data Lake Analytics tem de ser criada dentro de um grupo de Recursos do Azure. O [Azure Resource Manager](../azure-resource-manager/resource-group-overview.md) permite trabalhar com os recursos na aplicação como um grupo. Pode implementar, atualizar ou eliminar todos os recursos da aplicação numa operação única e coordenada.  
