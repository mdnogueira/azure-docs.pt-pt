---
title: Introdução à Análise do Azure Data Lake ao utilizar o SDK do .NET | Microsoft Docs
...
4. Adicione um novo ficheiro ao projeto denominado **SampleUSQLScript.txt**, e, em seguida, cole o seguinte script U-SQL. As tarefas de Data Lake Analytics são escritas em linguagem U-SQL. Para saber mais sobre U-SQL, consulte [Introdução à linguagem U SQL](data-lake-analytics-u-sql-get-started.md) e [Referência de linguagem U-SQL](http://go.microsoft.com/fwlink/?LinkId=691348).
   ...
   > [!NOTE]
   > Neste momento não existe um problema conhecido com o Azure Data Lake Service.  Se a aplicação de amostra for interrompida ou encontrar um erro, poderá ter de eliminar manualmente as contas do Data Lake Store e do Data Lake Analytics que o script cria.  Se não estiver familiarizado com o Portal, o guia [Manage Azure Data Lake Analytics using Azure porta (Gerir o Azure Data Lake Analytics com o Portal do Azure)](data-lake-analytics-manage-use-portal.md) ajudá-lo-á a começar.       
   > 
   > 
...
1. Prima **F5** para executar a aplicação. O resultado é semelhante a:
...
2. Veja o ficheiro de saída.  O caminho predefinido e o nome do ficheiro é c:\Temp\SearchLog-from-Data-Lake.csv. 
