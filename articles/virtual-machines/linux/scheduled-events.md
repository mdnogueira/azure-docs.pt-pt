...
Eventos agendados está disponível para o Windows e VMs com Linux. Para obter informações sobre eventos agendadas no Windows, consulte [agendada eventos para VMs do Windows](../windows/scheduled-events.md).
