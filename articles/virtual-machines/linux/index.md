...
<div class="introHolder">
    <div class="intro">
Saiba como executar Máquinas Virtuais utilizando a distribuição Linux da sua preferência. Documentação, referências de API e exemplos mostram-lhe várias formas de criar e implementar modelos de VM.
    </div>
    <div class="calloutHolder">
        <div class="callout">
            <a href="https://azure.microsoft.com/community/training/courses/managing-infrastructure-microsoft-azure-getting-started/">
                <img src="media/index/pluralsight.svg" /> Vídeo de formação gratuita da PluralSight - Gerir a Infraestrutura com o Microsoft Azure </a>
        </div>
    </div>
</div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Criar uma VM com Linux através da CLI do Azure 2.0</h3>
                    </div>
                </div>
            </div>
        </div>
