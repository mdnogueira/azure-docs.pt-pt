...
Pode optar por [carregar e utilizar a sua própria imagem](upload-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) e quando o fizer, o nome do publicador, a oferta e o sku não são utilizados.
...
| Azure PowerShell |Para obter informações sobre como utilizar o PowerShell para gerir VMs, consulte [Manage Azure Virtual Machines using Resource Manager and PowerShell (Gerir Máquinas Virtuais do Azure com o Gestor de Recursos e o PowerShell)](ps-manage.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json). |
