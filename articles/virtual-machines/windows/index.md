...
<div class="content">
    ...
    <p style="padding-bottom: 0px; max-width: 1050px;">As Máquinas Virtuais do Windows no Azure fornecem uma infraestrutura a pedido, altamente dimensionável, segura e virtualizada através do Windows Server. Saiba como criar, configurar, gerir e dimensionar VMs do Windows com os nossos inícios rápidos, tutoriais e amostras.</p>
<h2 style="margin-top: 36px; margin-bottom: 0px;">Inícios rápidos</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Crie uma VM do Windows com:</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<div class="columnHolder">
    <div class="column50">
        ...
        <p>Crie e implemente máquinas virtuais do Windows.</p>
        <ul class="spaced">
            <li><a href="/azure/virtual-machines/virtual-machines-windows-tutorial-manage-vm?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json">Criar e gerir VMs do Windows</a></li>
            <li><a href="/azure/virtual-machines/virtual-machines-windows-load-balanced-iis-tutorial?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json">Balanceamento de carga de VMs de elevada disponibilidade</a></li>
        </ul>
        <h2>Amostras</h2>
