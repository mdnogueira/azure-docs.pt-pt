---
title: "Script CLI do Azure de exemplo - criar uma VM do Windows Server 2016 com a monitorização do OMS | Microsoft Docs"
description: "Script CLI do Azure de exemplo - criar uma VM do Windows Server 2016 com a monitorização do OMS"
