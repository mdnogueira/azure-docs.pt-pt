---
title: Criar uma VM com o IIS utilizando o DSC e AzVM de novo no Azure | Microsoft Docs
description: Exemplo de Script do PowerShell do Azure - criar uma VM do IIS com DSC e AzVM de novo.
...
---
# <a name="create-an-iis-vm-with-powershell-using-new-azvm-preview"></a>Criar uma VM do IIS com o PowerShell com o New-AzVM (pré-visualização)

Este script cria uma máquina de Virtual do Azure a executar o Windows Server 2016 utilizando New-AzVM e, em seguida, utiliza a extensão de DSC de Máquina Virtual do Azure para instalar o IIS. Depois de executar o script, pode aceder o Web site do IIS predefinido no endereço IP público da máquina virtual.
