...
Saiba como criar uma conta de armazenamento do Azure e uma aplicação de função do Azure para armazenar mensagens de hub IoT no seu armazenamento de tabela.
