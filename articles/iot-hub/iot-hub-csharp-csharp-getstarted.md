...
description: "IoT Hub do Azure com tutorial de introdução à C# Utilize o Hub IoT do Azure e o C# com os SDKs IoT do Azure para implementar uma solução de Internet das Coisas."
services: iot-hub
...
Este tutorial guia-o pelos passos para criar um dispositivo-cliente do IoT Hub. Pode ainda utilizar a extensão do Visual Studio [Serviço Ligado para o Hub IoT do Azure][lnk-connected-service] para adicionar o código necessário à aplicação do seu dispositivo-cliente.
