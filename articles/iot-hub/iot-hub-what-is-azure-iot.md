...
O IoT Hub do Azure é um serviço do Azure que permite comunicações bidirecionais seguras e fiáveis entre a sua aplicação de back-end e milhões de dispositivos. Permite à aplicação de back-end receber telemetria à escala dos seus dispositivos, encaminhar esses dados para um processador de fluxo de eventos e ainda enviar comandos da nuvem para o dispositivo para dispositivos específicos. Pode utilizar o IoT Hub para implementar a sua própria solução de back-end. Além disso, o IoT Hub inclui um registo de identidade do dispositivo utilizado para aprovisionar dispositivos, as suas credenciais de segurança e os seus direitos de ligação ao Hub. Para saber mais, consulte:

- [O que é o IoT Hub?][lnk-iot-hub]
- [Introdução ao IoT Hub][lnk-getstarted]
- [Descrição geral da gestão do dispositivo IoT Hub do Azure][lnk-device-management]
