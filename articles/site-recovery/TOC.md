...
# Introdução
## [Replicar VMs do Azure para o Azure (pré-visualização)](site-recovery-azure-to-azure.md)
...
## Gerir
### [Atualizar o seu cofre do Site Recovery para o cofre dos Serviços de Recuperação](upgrade-site-recovery-vaults.md)
