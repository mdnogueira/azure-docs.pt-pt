...
Saiba como utilizar o Site Recovery para contribuir para a sua estratégia de continuidade do negócio e recuperação após desastre, para manter as aplicações e as cargas de trabalho disponíveis durante os tempos de inatividade. Os tutoriais e os outros artigos mostram-lhe como planear, implementar e gerir a replicação, a ativação pós-falha e a recuperação de computadores no local e de VMs do Azure.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à replicação de VMs do Hyper-V para o Azure (sem o VMM)</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução à replicação de VMs do Hyper-V nas clouds do VMM para o Azure</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/servicemanagement/azure.siterecovery/v3.1.0/azure.siterecovery">PowerShell clássico</a></p>
                    </div>
                </div>
            </div>
        </div>
