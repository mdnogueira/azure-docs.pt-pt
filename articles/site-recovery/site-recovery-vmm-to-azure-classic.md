...
## Pré-requisitos de mapeamento da rede
...
## Passo 1: Criar um cofre de Recuperação de Sites
...
## Passo 2: Gerar uma chave de registo do cofre
...
## Passo 3: Instalar o Fornecedor do Azure Site Recovery
...
## Passo 4: Criar uma conta de armazenamento do Azure
...
## Passo 6: Configurar definições de proteção na nuvem
...
## Passo 7: Configurar o mapeamento da rede
...
3. Verifique as propriedades da máquina virtual e modifique conforme necessário.

    ![Verificar as máquinas virtuais](./media/site-recovery-vmm-to-azure-classic/vm-properties.png)


4. No separador**Configurar** das propriedades da máquina virtual, pode modificar as seguintes propriedades de rede.
...
>[AZURE.NOTE] As máquinas virtuais Linux com endereço IP estático não são suportadas.
