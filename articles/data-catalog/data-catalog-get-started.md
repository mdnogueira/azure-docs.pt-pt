...
### Base de dados de exemplo da Adventure Works
...
### Detetar recursos de dados com a pesquisa básica
...
### Detetar recursos de dados com o âmbito de propriedade
...
> [AZURE.NOTE] As capacidades de gestão descritas neste exercício só estão disponíveis na Edição Standard do Catálogo de Dados do Azure e não na Edição Gratuita.
...
- [How to document data assets (Como ligar a recursos de dados)](data-catalog-how-to-connect.md)
