...
---
# <a name="adopting-azure-data-catalog"></a>Adotar o Catálogo de Dados do Azure
...
* **Declaração de Visão** - Isto ajuda-o a discutir de forma concisa o plano de adoção com os utilizadores e intervenientes. É a sua abordagem rápida.
...
* **Especificar os objetivos e a linha cronológica** - Isto vai garantir que o seu plano de adoção tem resultados específicos e alcançáveis. Uma linha cronológica mantém todas as pessoas focadas e permite que os pontos de verificação meçam o sucesso.
