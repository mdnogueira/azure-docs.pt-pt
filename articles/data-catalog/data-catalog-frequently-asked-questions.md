...
Para submeter pedidos de funcionalidades e outros comentários, vá para o [fórum do catálogo de dados do Azure](http://go.microsoft.com/fwlink/?LinkID=616424&clcid=0x409).
...
2. Na aplicação de publicação do catálogo de dados, inicie sessão com as mesmas credenciais que utiliza para aceder ao portal do catálogo de dados.
...
Ativamente estamos a trabalhar adicionar mais origens de dados no catálogo de dados. Se pretender ver uma origem de dados específicos suportada, sugerimos (ou o suporte de voz, se já tiver sido sugerido) acedendo ao [fórum do catálogo de dados do Azure](http://go.microsoft.com/fwlink/?LinkID=616424&clcid=0x409).
