...
3. Execute os seguintes passos para cada computador Linux.
   ...
   b. Para remover o agente, utilize o processo descrito na secção [Desinstalar o Agente OMS para Linux](https://github.com/Microsoft/OMS-Agent-for-Linux/blob/master/docs/OMS-Agent-for-Linux.md#uninstalling-the-oms-agent-for-linux).  
