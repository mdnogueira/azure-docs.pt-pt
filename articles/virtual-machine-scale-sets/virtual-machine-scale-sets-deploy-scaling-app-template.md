...
# Implementar uma aplicação de dimensionamento automático através de um modelo
...
### Servidor de HTTP do Python no Linux
...
### Aplicação ASP.NET MVC no Windows
