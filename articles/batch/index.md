        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre o Batch</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Batch com .NET</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Batch com Python</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Batch com Node.js</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Batch</h3>
                        <p><a href="/azure/batch/batch-diagnostics">Registos de diagnóstico do Batch</a></p>
                        <p><a href="/azure/batch/batch-analytics">Batch Analytics</a></p>
                        <p><a href="/azure/batch/batch-compute-node-environment-variables">Variáveis de ambiente do nó de computação do Batch</a></p>
                    </div>
                </div>
            </div>
        </div>
