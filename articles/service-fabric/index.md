---
title: "Documentação do Azure Service Fabric - Tutoriais, Referência da API | Microsoft Docs"
description: "Saiba como utilizar plataforma o middleware do Service Fabric para empacotar e implementar micro-serviços para aplicações de dimensionamento na cloud. Tutoriais, referências de API e códigos de exemplo."
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Saiba mais sobre o Service Fabric</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de Vídeos do Service Fabric</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Service Fabric com C# para Windows</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Service Fabric com C# para Linux</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introdução ao Service Fabric com Java</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Linguagens</h3>
                        <p><a href="/java/api">API de Java</a></p>
