...
Os comandos da CLI para interagir com entidades do Service Fabric, incluindo clusters, aplicações e serviços.

## <a name="create-application-on-you-mac-using-yeoman"></a>Criar aplicação no Mac com o Yeoman
