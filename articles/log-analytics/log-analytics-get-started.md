...
>[!NOTE]
>Se utiliza a Cloud Microsoft Azure Government, utilize a [documentação Monitorização + Gestão do Azure Government](https://review.docs.microsoft.com/azure/azure-government/documentation-government-services-monitoringandmanagement#log-analytics) em alternativa.
