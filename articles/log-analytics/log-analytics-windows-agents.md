...
>[!NOTE]
Para máquinas virtuais em execução no Azure, pode simplificar a instalação utilizando a [extensão da máquina virtual](../virtual-machines/windows/extensions-oms.md).
