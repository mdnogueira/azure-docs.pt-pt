...
[Como implementar uma atualização de serviço para produção por trocar VIPs no Azure]: cloud-services-how-to-manage-portal.md#how-to-swap-deployments-to-promote-a-staged-deployment-to-production
