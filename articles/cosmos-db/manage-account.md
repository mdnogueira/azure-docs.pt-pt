...
No [portal do Azure](https://portal.azure.com/), acesso a **chaves** página no menu de recurso no **conta de base de dados do Azure Cosmos** página para ver, copiar e regenerar as chaves de acesso que são utilizadas para aceder à sua conta de base de dados do Azure Cosmos.
...
No **chaves** página, clique em de **cópia** botão à direita da chave que pretende copiar.
...
3. No **conta de base de dados do Azure Cosmos** página, clique em **chaves**.
4. No **chaves** página, clique no botão regenerar, em seguida, clique em **Ok** para confirmar que pretende gerar uma nova chave.
