    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3><a href="https://msdn.microsoft.com/library/mt238365.aspx">Ferramentas do SQL Server</a></h3>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3><a href="https://msdn.microsoft.com/library/mt654049.aspx">Controladores do SQL Server</a></h3>
