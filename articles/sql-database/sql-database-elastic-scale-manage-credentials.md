...
O [biblioteca de clientes de base de dados elástica](http://www.nuget.org/packages/Microsoft.Azure.SqlDatabase.ElasticScale.Client/) utiliza três diferentes tipos de credenciais para aceder a [Gestor de mapa de partições horizontais](sql-database-elastic-scale-shard-map-management.md). Consoante a necessidade de utilizar a credencial com o nível mais baixo de acesso possíveis.
