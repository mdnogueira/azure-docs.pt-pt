---
title: "SQL Database do Azure de deteção de ameaças exemplo auditoria do PowerShell | Microsoft Docs"
description: "Script de exemplo do PowerShell do Azure para configurar a deteção de ameaças e auditoria numa base de dados SQL do Azure"
...
---
# <a name="use-powershell-to-configure-sql-database-auditing-and-threat-detection"></a>Utilizar o PowerShell para configurar a base de dados SQL auditoria e deteção de ameaças

Neste exemplo de script do PowerShell configura a base de dados SQL auditoria e deteção de ameaças. 
...
| [Conjunto AzureRmSqlDatabaseAuditingPolicy](/powershell/module/azurerm.sql/set-azurermsqldatabaseauditingpolicy) | Define a política de auditoria para uma base de dados. |
| [Conjunto AzureRmSqlDatabaseThreatDetectionPolicy](/powershell/module/azurerm.sql/set-azurermsqldatabasethreatdetectionpolicy) | Define uma política de deteção de ameaças de uma base de dados. |
