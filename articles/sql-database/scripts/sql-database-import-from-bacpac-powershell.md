...
---
# <a name="use-powershell-to-import-a-pacpac-file-into-an-azure-sql-database"></a>Utilizar o PowerShell para importar um ficheiro PACPAC para uma base de dados SQL do Azure
