...
## <a name="troubleshooting-sync"></a>Resolução de problemas de sincronização
...
## <a name="troubleshooting-the-client-agent"></a>O agente do cliente de resolução de problemas
...
-   Crie um novo agente no mesmo centro de dados como o grupo de sincronização. Em seguida, registe a base de dados com que o agente.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Resolução de problemas de configuração e manutenção
...
Se restaurar uma base de dados perdido ou danificado a partir de uma cópia de segurança, poderá ser-se a convergência de dados nos grupos de sincronização a que pertence a base de dados.
