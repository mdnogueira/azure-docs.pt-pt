---
title: "API REST: Regras de firewall ao nível do servidor da Base de Dados SQL do Azure | Microsoft Docs"
description: "Saiba como configurar regras de firewall ao nível do servidor para endereços IP que acedem a bases de dados SQL do Azure através da API REST."
