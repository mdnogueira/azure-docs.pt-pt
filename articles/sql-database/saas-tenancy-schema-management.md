...
1. No SSMS, navegue para o *contosoconcerthall* da base de dados no *tenants1-dpt -\<utilizador\>*  servidor e consulta o *VenueTypes* tabela Confirme que *da sua motocicleta Racing* e *Swimming Club* **são** agora na lista de resultados.
...
[Tutorial de análises ad hoc](saas-tenancy-adhoc-analytics.md)
