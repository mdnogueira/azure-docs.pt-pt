...
| Suporte de idiomas | [**Analisadores de idioma** ](https://docs.microsoft.com/rest/api/searchservice/language-support) de Lucene, bem como processadores de linguagem natural da Microsoft disponíveis no 56 idiomas diferentes para processar inteligentemente linguistics específicas do idioma, incluindo tenses verbo, sexo, dados plural os substantivos (por exemplo, ' rato' versus 'ratos'), word anular compounding, quebra de palavra (para idiomas sem espaços) e muito mais. |
