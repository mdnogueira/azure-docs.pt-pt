<properties
    pageTitle="Introdução à Azure Search em Java | Microsoft Azure | Serviço de pesquisa em nuvem alojado"
...
## Sobre os ficheiros de programa
...
## Configurar o URL do serviço e a chave de API
...
## Configurar os ambientes de tempo de execução, compilação e projeto
...
7. Selecione **Janela** > **Preferências** > **Java** > **JREs Instalados** > **Adicionar**.

8. Em **Adicionar JRE**, selecione **VM Standard**.
...
8. Em Editar Configuração, em Objetivos, digite "instalação de raiz" e, em seguida, clique em **Executar**.
