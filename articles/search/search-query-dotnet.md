---
title: "Consultar o Índice da Azure Search através do SDK .NET | Microsoft Docs"
...
## Identificar a sua chave de API de consulta do serviço Azure Search
...
## Criar uma instância da classe SearchIndexClient
