<properties
    pageTitle="Como utilizar o Fiddler para avaliar e testar as APIs REST da Azure Search | Microsoft Azure | Serviço de pesquisa na nuvem alojado"
...
3. No separador **Compositor**, irá formular um pedido parecido com a seguinte captura de ecrã.

    ![][1]

2. Selecione **PUT**.

3. Introduza um URL que especifica o URL de serviço, os atributos de pedido e a versão de API. Alguns pontos a ter em atenção:
...
4.  Especifique o cabeçalho do pedido, substituindo o anfitrião e a chave de API por valores válidos para o serviço.
...
5.  No Corpo do Pedido, cole os campos que compõem a definição do índice.
