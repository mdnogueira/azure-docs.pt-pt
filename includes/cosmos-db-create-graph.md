...
2. Em **Explorador de dados (pré-visualização)**, selecione **gráfico novo**. Em seguida, preencha a página utilizando as seguintes informações:
    ...
    ---|---|---
    Id da base de dados|base de dados de exemplo|Introduza *base de dados de exemplo* como o nome para a nova base de dados. Os nomes de base de dados tem de estar entre 1 e 255 carateres e não pode conter `/ \ # ?` ou um espaço à direita.
    ID do gráfico|gráfico de exemplo|Introduza *exemplo gráfico* como o nome para a nova coleção. Os nomes de gráfico têm os mesmos requisitos de caráter como IDs da base de dados.
