...
Os tamanhos da série Dsv3 baseiam-se no processador 2.3 GHz Intel XEON ® E5-2673 v4 (Broadwell) e podem chegar aos 3.5GHz com o Intel Turbo Boost Technology 2.0 e utilizar o armazenamento premium. Os tamanhos da série Dsv3 oferecem uma combinação de CPU, memória e disco local para a maioria das cargas de trabalho de produção.
...
Os tamanhos da série Dv3 são baseadas no processador de 2.3 GHz Intel XEON ® E5-2673 v4 (Broadwell) e pode chegar aos 3.5 GHz com o Intel Turbo Boost Technology 2.0. Os tamanhos da série Dv3 oferecem uma combinação de CPU, memória e disco local para a maioria das cargas de trabalho de produção.
...
| Tamanho             | vCPU | Memória: GiB | SSD Local: GiB | Discos de dados máximos | Débito máximo do disco em cache e local: IOPS/MBps (tamanho da cache em GiB) | Débito máximo do disco não colocado em cache: IOPS/MBps | NICs. Máx. / Desempenho de rede esperado (Mbps) |
|------------------|-----------|-------------|----------------|----------------|-----------------------------------------------------------------------|-------------------------------------------|------------------------------------------------|
| Standard_D2_v3  | 2         | 8           | 16             | 4              | 4,000 / 32 (50)                                                       | 3,200 / 48                                | 2/moderado                                   |
| Standard_D4_v3  | 4         | 16          | 32             | 8              | 8,000 / 64 (100)                                                      | 6,400 / 96                                | 2/moderado                                   |
| Standard_D8_v3  | 8         | 32          | 64             | 16             | 16,000 / 128 (200)                                                    | 12,800 / 192                              | 4 / alto                                       |
| Standard_D16_v3 | 16        | 64          | 128            | 32             | 32,000 / 256 (400)                                                    | 25,600 / 384                              | 8 / alto                                       |
...
| Tamanho | Núcleos de CPU | Memória: GiB | HDD Local: GiB | Discos de dados máximos | Débito máximo do disco de dados: IOPS | NICs. Máx. / Desempenho de rede esperado (Mbps)  |
| --- | --- | --- | --- | --- | --- | --- |
...
|Tamanho – Tamanho\Nome |Núcleos de CPU|Memória|NICs (Máx)|Tamanho máximo do disco temporário |Um máximo de discos de dados 1023 GB cada)|Um máximo de IOPS (300 por disco)|
|---|---|---|---|---|---|---|
