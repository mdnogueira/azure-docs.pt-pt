...
| Número de cofres de cópia de segurança que podem ser criados em cada subscrição do Azure |25 (cofres de cópia de segurança) <br/> 25 dos serviços de recuperação cofre por região |
