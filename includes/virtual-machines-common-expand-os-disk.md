...
5. Eis o momento pelo qual tanto esperou! Defina o tamanho do disco de SO para o valor pretendido e atualize a VM da seguinte forma:
   ...
   > [!WARNING]
   > O novo tamanho deve ser maior que o tamanho do disco existente. O máximo permitido é de 2048 GB. (É possível expandir o blob VHD esse tamanho, mas o SO apenas será possível trabalhar com o primeira 2048 GB de espaço).
   > 
   > 
