...
* [Como a cache de redis ativado](../articles/redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md) utilizando [Plug-in de cache de redis](https://wordpress.org/plugins/wp-redis/)
* [Ativar o wincache com W3 Plug-in de total cache](https://wordpress.org/plugins/w3-total-cache/)
* [Como utilizar o plug-in do supercache para acelerar a aplicação WordPress](http://ruslany.net/2008/12/speed-up-wordpress-on-iis-70/)
* [Como servidor de IIS a utilizar a colocação em cache de saída a colocação em cache](http://blogs.msdn.com/b/brian_swan/archive/2011/06/08/performance-tuning-php-apps-on-windows-iis-with-output-caching.aspx)
* [Como colocação em cache do browser ativado para conteúdo estático](http://www.iis.net/configreference/system.webserver/staticcontent)
